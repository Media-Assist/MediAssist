...
import com.example.mediassist.Doctor.DoctorsList;
...
public class SpecializationAdapter extends RecyclerView.Adapter<SpecializationAdapter.MyViewHolder>{
    ...
    public void setImage(int i) {
        ...
        if (i == 1) {
            imageView.setImageDrawable(context.getResources().getDrawable(R.drawable.stethoscope));
        } else {
            imageView.setImageDrawable(context.getResources().getDrawable(R.drawable.injection));
        }
